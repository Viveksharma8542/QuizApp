...
const StudentPanel = () => {
  ...
  const menuItems = [
    ...
    { path: '/student/quizzes', label: 'Available Quizzes', icon: BookOpen },
    { path: '/student/history', label: 'Quiz History', icon: ClipboardCheck }
  ];
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-gray-50">
          <Routes>
            ...
            <Route path="/history" element={<StudentQuizList />} />
