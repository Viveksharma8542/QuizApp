...
const TeacherPanel = () => {
  ...
  const menuItems = [
    ...
    { path: '/teacher/quizzes', label: 'My Quizzes', icon: BookOpen },
    { path: '/teacher/results', label: 'View Results', icon: ClipboardList }
  ];
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white shadow-sm lg:hidden">
          <div className="flex items-center justify-between p-4">
            ...
            <h1 className="text-lg font-semibold text-gray-800">Teacher Panel</h1>
